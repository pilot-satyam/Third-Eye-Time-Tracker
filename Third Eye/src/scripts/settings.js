...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('grantPermissionForAmazonPrime').addEventListener('click', function () {
        grantPermissionForAmazonPrime();
    });
...
function checkPermissionsForAmazonPrime() {
    chrome.permissions.contains({
        permissions: ['tabs'],
        origins: ["https://www.primevideo.com/*"]
    }, function (result) {
        if (result) {
            setUIForAnyPermissionForAmazonPrime();
        }
    });
}
...
function grantPermissionForAmazonPrime() {
    chrome.permissions.request({
        permissions: ['tabs'],
        origins: ["https://www.primevideo.com/*"]
    }, function (granted) {
...
function setUIForAnyPermissionForAmazonPrime() {
    document.getElementById('permissionSuccessedBlockForAmazonPrime').hidden = false;
    document.getElementById('permissionSuccessedBlockForAmazonPrime').classList.add('inline-block');
    document.getElementById('grantPermissionForAmazonPrime').hidden = true;
}
